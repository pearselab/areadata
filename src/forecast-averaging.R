...
print("forecasting for countries (GID 0)")
...
print("forecasting for states (GID 1)")
...
print("forecasting for counties (GID 2), this will be slowest...")
...
print("forecasting for UK NUTS regions")
...
print("forecasting for UK LTLA regions")
