...
if("temperature" %in% climvars){
    ...
    saveRDS(old.UK_LTLA.temp, paste("output/temp-dailymean-UK-LTLA-", enddate, ".RDS", sep = ""))
}
...
if("humidity" %in% climvars){
    ...
    saveRDS(old.UK_LTLA.humid, paste("output/humid-dailymean-UK-LTLA-", enddate, ".RDS", sep = ""))
}
...
if("uv" %in% climvars){
    ...
    saveRDS(old.UK_LTLA.uv, paste("output/uv-dailymean-UK-LTLA-", enddate, ".RDS", sep = ""))
}
